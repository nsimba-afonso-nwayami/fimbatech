...
const faqData = [
  {
    ...
    answer: 'Somos agnósticos, mas priorizamos tecnologias modernas e escaláveis. Usamos JavaScript (React, Node.js), Python, Cloud Computing (AWS/GCP), Docker e arquiteturas de Microsserviços para garantir desempenho e longevidade.',
  },
  {
    id: 2,
    question: 'Qual o processo de desenvolvimento de um projeto sob medida?',
    answer: 'Nosso processo começa com a Descoberta (briefing detalhado e escopo), seguido por Design (UI/UX e prototipagem), Desenvolvimento Ágil (sprints com entregas contínuas), Testes e, finalmente, Lançamento e Suporte.',
  },
  {
    id: 3,
    question: 'A FimbaTec oferece suporte após a entrega do projeto?',
    answer: 'Sim! Oferecemos planos de suporte e manutenção personalizados. Isso inclui correções de bugs, atualizações de segurança e melhorias contínuas para garantir que sua solução opere com eficiência máxima.',
  },
  {
    id: 4,
    question: 'Quanto tempo leva para desenvolver um sistema?',
    answer: 'O tempo de desenvolvimento varia muito dependendo da complexidade e do escopo. Um projeto médio pode levar de 3 a 6 meses. Após a fase de Descoberta, fornecemos um cronograma detalhado e realista.',
  },
];
...
          <p className="text-gray-300 max-w-3xl mx-auto mb-16 text-lg">
            A satisfação de quem confia na FimbaTec para impulsionar seus negócios.
          </p>
...
            {/* Depoimento 1 */}
            <div
              className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-2xl hover:bg-white/10 transition duration-300 text-left flex flex-col items-start"
            >
...
                "O sistema que a FimbaTec desenvolveu transformou nossa operação. A integração
                de processos reduziu erros e nos deu uma visão clara do negócio. Profissionais 
...
                />
                <div>
                  <h4 className="font-semibold text-gray-100">Ana Clara Souza</h4>
                  <p className="text-sm text-gray-400">CEO, TechInov Soluções</p>
                </div>
              </div>
            </div>
...
              <i className="fa-solid fa-quote-left text-3xl text-cyan-400 mb-4"></i>
              <p className="text-gray-300 text-base italic leading-relaxed mb-6 grow">
                "Contratamos a consultoria para refatorar nossa arquitetura, e o resultado 
                foi *impecável*. Ganho de performance e escalabilidade que não imaginávamos. 
                O time é muito profissional e entende profundamente de tecnologia."
              </p>
              {/* Informações do Cliente */}
              <div className="flex items-center mt-auto">
                <img 
...
                />
                <div>
                  <h4 className="font-semibold text-gray-100">Roberta Mendes</h4>
                  <p className="text-sm text-gray-400">Diretor de TI, Global Data Corp</p>
                </div>
              </div>
            </div>
...
              <i className="fa-solid fa-quote-left text-3xl text-cyan-400 mb-4"></i>
              <p className="text-gray-300 text-base italic leading-relaxed mb-6 grow">
                "O App mobile superou todas as expectativas. Fluido, com design moderno e 
                totalmente adaptado às nossas necessidades. A atenção aos detalhes do UX/UI
...
                  <p className="text-sm text-gray-400">Gerente de Produto, ConnectApp</p>
                </div>
              </div>
            </div>
          </div>
...
            Vamos além do código. Utilizamos tecnologia disruptiva para construir a próxima
            geração de sistemas e soluções, garantindo que seu negócio esteja sempre um passo à frente.
          </p>
...
                Criamos algoritmos de IA para automação de decisões, análise preditiva e personalização de experiências em tempo real.
              </p>
            </div>
...
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                Desenvolvemos arquiteturas resilientes e otimizadas na Nuvem, prontas para suportar picos e crescimento global.
              </p>
            </div>
...
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                Exploramos a descentralização para criar plataformas seguras, transparentes e imutáveis, construindo o futuro digital.
              </p>
            </div>
            
            {/* Card 4: IoT */}
...
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                Conectamos dispositivos e dados em ecossistemas inteligentes para otimizar operações, logística e eficiência em campo.
              </p>
            </div>
          </div>
          
      ...
      <section className="py-16 bg-gray-950 text-center">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mb-12">
            Empresas líderes em seus segmentos que confiam na FimbaTec para impulsionar sua inovação e crescimento.
          </p>
          ...
          >
            {clientIcons.map((item) => (
              <SwiperSlide key={item.id} className="flex items-center justify-center py-4">
                <i 
              ...
              >
                ...
                <div
                  ...
                  className={`overflow-hidden transition-all duration-500 ease-in-out ${
                    openQuestion === item.id ? 'max-h-96 opacity-100 p-5 pt-0' : 'max-h-0 opacity-0'
                  }`}
                >
