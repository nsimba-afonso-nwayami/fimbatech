          ...
          <div className="content relative z-10 max-w-3xl px-6">
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a
                href="#"
                className="
                  bg-blue-900 px-6 py-3 rounded-lg text-white font-semibold
                  hover:bg-blue-950 transition shadow-lg
                "
              >
                Peça um orçamento
              </a>

              {/* Botão secundário → Tecnologia */}
              <a
                href="#"
                className="
                  bg-transparent border border-cyan-400 px-6 py-3 rounded-lg
                  text-cyan-400 font-semibold
                  hover:bg-cyan-400 hover:text-blue-950 transition shadow-md
                "
              >
                Tecnologia
              </a>
